...
$(function () {
    ...
    var fusrid = GetQueryString("fusrid");
    
    QueryChargRecord(serialnumid,snnumber,fusrid);
});
...
function QueryChargRecord(serialnumid,snnumber,fusrid) {	
		
	var queryData = {
	  	"serialnumber.funiqueid": serialnumid,
	  	"serialnumber.fusrid": fusrid
	  };
...
function ListRecordDetail(queryData) {
    $('#dgchargerecord').datagrid({
        loadMsg: "数据加载中,请稍候……",
        url: '/web1/snnumberQueryPushMsg.action',
        width: "auto",
