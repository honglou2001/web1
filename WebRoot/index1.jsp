...
<!--     </div> -->
	...
	<div data-options="region:'south',border:false"  style="overflow: hidden;height: 30px; /*background: #D2E0F2;*/">
        ...
        <div style="text-align: center;">Copyright © 2010-2015 Watch Technologies, Inc. All Rights Reserved&nbsp;&nbsp;<a target="_blank" style=" color:Blue;" href="http://www.dodopuppy.com">http://www.dodopuppy.com</a></div>
	...
	<div id="mainPanle" data-options="region:'center'">
     ...
     <!--修改密码窗口-->
    <div id="div_pwd" class="easyui-window" title="修改密码" collapsible="false" minimizable="false"
        maximizable="false" icon="icon-save" style="width: 300px; height: 150px; padding: 5px; background: #fafafa;" closed="true">
