...
{
	string classname = StringUtil.ToPascalCase(TableName.Replace("t_",""));
	
	return classname;
}

public string ParameterName(string TableName)
{
	string classname = StringUtil.ToCamelCase(ClassName(TableName));
